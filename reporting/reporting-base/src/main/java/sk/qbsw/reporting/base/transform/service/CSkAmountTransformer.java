...
import sk.qbsw.reporting.base.transform.exception.CNotSupportedAmountException;
import sk.qbsw.reporting.base.transform.model.CTransformedAmount;
...
{
	/* (non-Javadoc)
	 * @see sk.qbsw.reporting.base.transform.service.IAmountTransformer#transformToStringLongFormat(java.math.BigDecimal)
	 */
	@Override
