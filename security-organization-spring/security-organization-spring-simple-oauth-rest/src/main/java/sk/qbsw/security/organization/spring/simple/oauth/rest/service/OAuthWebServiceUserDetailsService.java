...
{
	private final AuthenticationClient<CSSimpleOrganizationAccountData> authenticationClient;
	 ...
	 */
	public OAuthWebServiceUserDetailsService (AuthenticationClient<CSSimpleOrganizationAccountData> authenticationClient)
	{
		super();
	...
	protected UserDetails createUserDetails (Authentication token)
	{
		...
		CSSimpleOrganizationAccountData accountData = verify((String) token.getPrincipal(), deviceId, ip).getAccountData();
	...
	private VerificationResponseBody<CSSimpleOrganizationAccountData> verify (String token, String deviceId, String ip)
	{
		try
		{
