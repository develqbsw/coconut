...
/**
 * Base class for vertical layout screen
 * 
 * @author Dalibor Rak
 * @version 0.1
 * @since 0.1
 */
public abstract class AScreenVertical extends VLayout implements IScreen, IControlable
{
	/**
	...
	/**
	 * Registers event source as origins of events for actual screen
	 * @param source
	 */
	public void registerAsEventSource (IApplicationEventSource source)
	{
		addToListeners(source);
	}
