package sk.qbsw.sgwt.winnetou.server.service.security;
...
public class CCodeGenerator implements ICodeGenerator
{
	 ...
	 * 
	 * @param characters
	 *            count of characters to be used for generating message
	 * @return message
	 */
	 ...
	 * @param characters
	 * @param min
	 *            minimum character used by the generation
	 * @param max
	 *            maximum character used by the generation
