 ...
 * @since 0.1
 */
public class CBusinessException extends Exception implements IsSerializable
{
	 ...
	 *            message text
	 */
	public CBusinessException(String s)
	{
		super(s, null);
	 ...
	 */
	public CBusinessException(String s, Throwable cause)
	{
		super(s, cause);
		this.message = CErrorConstants.winnetouExceptionPrefix + s;
	}
