...
/**
 * Chackbox Item for flag activated
 * 
 * @author Dalibor Rak
 * @Version 0.1
 * @since 0.1
 * 
 */
public class CActivatedCheckBoxItem extends CCheckBoxItem
{
	public CActivatedCheckBoxItem()
	{
		super();
		setTitle(ILabels.Factory.getInstance().item_flag_activated());
