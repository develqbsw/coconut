...
import sk.qbsw.sgwt.winnetou.ribana.forms.client.model.CCodeListRecord;
 ...
 * 
 */
public class AComboBoxItem extends ComboBoxItem
{
	/**
	...
	/**
	 * Identifies if the value in combobox is one of the values from model
	 */
	public boolean containsValueFromModel ()
	{
		Object strVal = (Object) getValue();
		return model.containsKey(strVal);
	}
	...
	public Long getValueAsLong ()
	{
		...
		if (strVal != null && model.containsKey(strVal))
		{
