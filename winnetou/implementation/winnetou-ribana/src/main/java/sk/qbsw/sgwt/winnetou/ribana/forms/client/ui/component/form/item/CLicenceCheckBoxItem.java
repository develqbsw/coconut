 ...
 * 
 */
public class CLicenceCheckBoxItem extends CCheckBoxItem
{
	public CLicenceCheckBoxItem()
	{
		super();
		setTitle(ILabels.Factory.getInstance().labelLicence());
		...
		setValidators(new CBooleanValidator(true, IMessages.Factory.getInstance().registration_accept_licence()));
	}
}
