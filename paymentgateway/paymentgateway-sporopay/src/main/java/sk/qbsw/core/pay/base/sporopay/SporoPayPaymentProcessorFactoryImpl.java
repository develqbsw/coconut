 ...
 *
 */
public class SporoPayPaymentProcessorFactoryImpl implements PaymentProcessorFactory
{
	 ...
	 * 
	 */
	public SporoPayPaymentProcessorFactoryImpl (SporoPayInitParams initparams)
	{
	...
	{
		return new SporoPayPaymentProcessor(context);
	}
