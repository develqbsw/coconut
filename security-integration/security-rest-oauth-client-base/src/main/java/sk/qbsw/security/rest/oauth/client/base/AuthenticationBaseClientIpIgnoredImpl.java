 ...
 * @since 1.18.0
 */
public abstract class AuthenticationBaseClientIpIgnoredImpl<T extends CSAccountData> implements AuthenticationClient<T>
{
	 ...
	 */
	public AuthenticationBaseClientIpIgnoredImpl (RestTemplate authenticationRestTemplate, UrlConfiguration configuration)
	{
