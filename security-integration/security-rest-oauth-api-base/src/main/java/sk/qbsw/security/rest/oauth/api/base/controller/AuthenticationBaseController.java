...
/**
 * The type Authentication base controller.
 *
...
public abstract class AuthenticationBaseController<T extends AccountData, S extends CSAccountData>
{
	private final OAuthServiceFacade<T> oAuthService;
	 ...
	 */
	@Autowired
	public AuthenticationBaseController (OAuthServiceFacade<T> oAuthService, SecurityMapper securityMapper)
	{
