...
public final class ShipToAddress implements RequestFields
{
	...
	/**
	 * Instantiates a new ship to address.
	 *
	 ...
	 */
	public ShipToAddress (String name, String street, String city, String state, Country country) throws IllegalArgumentException
	{
