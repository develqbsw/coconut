...
public final class ActivationDetails implements RequestFields
{
	...
	/**
	 * Instantiates a new activation details.
	 */
	 ...
	 *
	 * @param continueOnFailure the new failed initial amount action
	 */
	...
	public String toString ()
	{
		...
		return "instance of ActivationDetails class with the values: " + "nvpRequest: " + nvpRequest.toString();
	}
}
