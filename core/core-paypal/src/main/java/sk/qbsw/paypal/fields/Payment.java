...
public final class Payment implements RequestFields
{
	 ...
	 * for USD.
	 *
	 * @param amount the new insurance amount
	 * @throws IllegalArgumentException the illegal argument exception
	 */
	 ...
	 *
	 * @param discount the new shipping discount
	 * @throws IllegalArgumentException the illegal argument exception
	 */
	public void setShippingDiscount (String discount) throws IllegalArgumentException
	{
		...
		{
			throw new IllegalArgumentException("Amount " + discount + " is not valid. Amount has to have exactly two decimal " + "places seaprated by \".\" - example: \"50.00\"");
		}
	 ...
	 * Equivalent to nine characters maximum for USD.
	 *
	 * @param amount the new handling amount
	 * @throws IllegalArgumentException the illegal argument exception
	 */
	 ...
	 *
	 * @param source the new button source
	 * @throws IllegalArgumentException the illegal argument exception
	 */
	 ...
	 *
	 * @param method the new allowed payment method
	 */
	...
	public Map<String, String> getNVPRequest ()
	{
		...
		if ( (nvp.containsKey("HANDLINGAMT") || nvp.containsKey("SHIPPINGAMT")) && !nvp.containsKey("ITEMAMT"))
		{
