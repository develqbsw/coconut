...
public class CSecurityAuthenticationProvider extends ASecurityAuthenticationProvider
{
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.core.security.service.spring.ASecurityAuthenticationProvider#populateAuthentication(org.springframework.security.core.Authentication, sk.qbsw.core.security.model.domain.CUser, java.util.List)
	 */
	@Override
