...
public final class BillingPeriodDetails implements RequestFields
{
	...
	public enum BillingPeriod
	{
		...
		/** The DAY. */
		DAY ("Day"), /** The WEEK. */
 WEEK ("Week"), /** The SEM i_ month. */
 SEMI_MONTH ("SemiMonth"), /** The MONTH. */
 ...
 YEAR ("Year");
		...
		/**
		 * Instantiates a new billing period.
		 *
	...
	/**
	 * Instantiates a new billing period details.
	 *
	 ...
	 */
	public BillingPeriodDetails (BillingPeriod period, int frequency, String amount, Currency currency) throws IllegalArgumentException
	{
		...
		{
			throw new IllegalArgumentException("The combination of billing " + "frequency (" + billingFrequency + ") and billing " + "period (" + billingPeriod + ") must be less than or " + "equal to one year.");
		}
	 ...
	 * @throws IllegalArgumentException the illegal argument exception
	 */
	public void setTrialBilling (BillingPeriod period, int frequency, String amount) throws IllegalArgumentException
	{
	...
	public String toString ()
	{
		...
		return "instance of BillingPeriodDetails class with the values: " + "nvpRequest: " + nvpRequest.toString();
	}
}
