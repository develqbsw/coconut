 ...
 * @since 1.19.0
 */
public class OAuthServiceIpIgnoredCacheFacadeImpl extends BaseOAuthServiceCacheFacade<SimpleOrganizationAccountData> implements OAuthServiceFacade<SimpleOrganizationAccountData>
{
	/**
