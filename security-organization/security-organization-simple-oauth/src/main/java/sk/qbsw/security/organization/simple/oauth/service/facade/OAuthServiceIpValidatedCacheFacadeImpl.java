 ...
 * @since 1.19.0
 */
public class OAuthServiceIpValidatedCacheFacadeImpl extends BaseOAuthServiceCacheFacade<SimpleOrganizationAccountData> implements OAuthServiceFacade<SimpleOrganizationAccountData>
{
	/**
