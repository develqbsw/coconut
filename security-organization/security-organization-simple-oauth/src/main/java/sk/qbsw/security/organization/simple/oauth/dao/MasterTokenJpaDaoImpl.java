package sk.qbsw.security.organization.simple.oauth.dao;
...
import sk.qbsw.security.organization.simple.oauth.model.domain.QMasterToken;

import java.util.List;

/**
 * The simple organization master token dao.
 *
 * @author Tomas Lauro
 * @version 1.19.0
 * @since 1.19.0
