...
import sk.qbsw.security.organization.complex.oauth.db.model.domain.QAuthenticationToken;
 ...
 * @since 1.19.0
 */
public class AuthenticationTokenJpaDaoImpl extends AuthenticationTokenJpaDaoBase<UserAccount, AuthenticationToken> implements AuthenticationTokenDao<UserAccount, AuthenticationToken>
{
	/**
