 ...
 * @since 1.19.0
 */
public class OAuthServiceIpValidatedCacheFacadeImpl extends BaseOAuthServiceCacheFacade<ComplexOrganizationAccountData> implements OAuthServiceFacade<ComplexOrganizationAccountData>
{
	/**
