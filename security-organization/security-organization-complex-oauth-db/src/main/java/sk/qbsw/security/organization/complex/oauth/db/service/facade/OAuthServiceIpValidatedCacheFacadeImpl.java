package sk.qbsw.security.organization.complex.oauth.db.service.facade;
 ...
 * @since 1.19.0
 */
public class OAuthServiceIpValidatedCacheFacadeImpl extends BaseOAuthServiceCacheFacade<ComplexOrganizationAccountData> implements ComplexOrganizationOAuthServiceFacade<ComplexOrganizationAccountData>
{
	/**
	 ...
	 */
	public OAuthServiceIpValidatedCacheFacadeImpl (OAuthService<ComplexOrganizationAccountData> oAuthService)
	{
		super(oAuthService);
	}
