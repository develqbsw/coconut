...
/**
 * The complex organization OAuth auto configuration.
 *
 * @author Tomas Lauro
 * @version 2.6.0
 * @since 2.6.0
 */
@Configuration
@AutoConfigureAfter (CXOSecurityOAuthAutoConfigurationBase.class)
public class CXOSecurityOAuthAutoConfiguration
{
