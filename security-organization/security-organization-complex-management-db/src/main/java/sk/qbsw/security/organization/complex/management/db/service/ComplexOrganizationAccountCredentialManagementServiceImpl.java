...
/**
 * The complex Organization account credential management service.
 *
 * @author Tomas Lauro
 * @version 1.19.0
 * @since 1.19.0
 */
public class ComplexOrganizationAccountCredentialManagementServiceImpl extends AccountCredentialManagementServiceBase<UserAccount> implements AccountCredentialManagementService
{
	/**
	 ...
	 */
	public ComplexOrganizationAccountCredentialManagementServiceImpl (AccountDao<UserAccount> accountDao, AuthenticationParamsDao authenticationParamsDao, PasswordDigester digester, SecurityCoreConfigurator securityCoreConfigurator)
	{
