 ...
 * @since 1.19.0
 */
public class OAuthServiceIpIgnoredCacheFacadeImpl extends BaseOAuthServiceCacheFacade<SimpleOrganizationAccountData> implements SimpleOrganizationOAuthServiceFacade<SimpleOrganizationAccountData>
{
	/**
	 ...
	 */
	public OAuthServiceIpIgnoredCacheFacadeImpl (OAuthService<SimpleOrganizationAccountData> oAuthService)
	{
		super(oAuthService);
	}
