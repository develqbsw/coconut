...
public class UnitTestCase
{
	...
	public void testGetAllByAccount () throws CSecurityException
	{
		...
		Account accountWithDefaultUnit = accountManagementService.findByByLogin(DataGenerator.ACCOUNT_WITH_DEFAULT_UNIT_CODE);
		Account accountWithoutDefaultUnit = accountManagementService.findByByLogin(DataGenerator.ACCOUNT_WITHOUT_DEFAULT_UNIT_CODE);

		// first account
		List<Unit> units = unitService.findByAccount(accountWithDefaultUnit);
		...
		// second account
		units = unitService.findByAccount(accountWithoutDefaultUnit);
