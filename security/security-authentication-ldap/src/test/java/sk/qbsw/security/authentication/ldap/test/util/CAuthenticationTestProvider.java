...
public class CAuthenticationTestProvider
{
	 ...
	 * @throws CSecurityException the security exception
	 */
	public void testChangeEncryptedPasswordNewUser (IAuthenticationService authenticationService, IUserManagementService userService, IUserDao userDao, IOrganizationService orgService, CDataGenerator dataGenerator) throws CSecurityException
	{
