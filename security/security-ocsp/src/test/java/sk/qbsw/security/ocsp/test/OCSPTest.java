package sk.qbsw.security.ocsp.test;
...
import sk.qbsw.security.ocsp.service.OCSPHttpURLConnection;
...
public class OCSPTest {
	...
	public static void main(String[] args) throws Exception {
		...
		OCSPCertValidator validator = new OCSPCertValidatorBCImpl();
	 ...
	 *            the in
	 */
	private static void validateCertificate(OCSPCertValidator validator, InputStream in) {
		OCSPValidationResult validationResult = validator.processResponse(in);
