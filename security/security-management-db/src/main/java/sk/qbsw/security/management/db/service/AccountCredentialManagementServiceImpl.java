 ...
 * @since 1.0.0
 */
public class AccountCredentialManagementServiceImpl extends AccountCredentialManagementServiceBase<Account> implements AccountCredentialManagementService
{
	/**
	 ...
	 */
	public AccountCredentialManagementServiceImpl (AccountDao<Account> accountDao, AuthenticationParamsDao authenticationParamsDao, PasswordDigester digester, SecurityCoreConfigurator securityCoreConfigurator)
	{
