...
import sk.qbsw.security.model.domain.QCOrganization;
...
public class COrganizationJpaDao extends AEntityQDslDao<Long, COrganization> implements IOrganizationDao
{
	...
	/*
	 * (non-Javadoc)
	 * @see sk.qbsw.security.dao.IOrganizationDao#findByName(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see sk.qbsw.security.dao.IOrganizationDao#findOneByName(java.lang.String)
	 */
	@Deprecated
	@Override
