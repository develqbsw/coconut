...
import sk.qbsw.security.model.domain.EAuthParameters;
import sk.qbsw.security.model.domain.EAuthSchema;
import sk.qbsw.security.model.domain.EHashMethod;
...
public class CAuthenticationConfigurator extends AService implements IAuthenticationConfigurator
{
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.model.jmx.IAuthenticationConfigurator#setLdapPasswordHashMethod(sk.qbsw.security.model.domain.EHashMethod)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.model.jmx.IAuthenticationConfigurator#getDatabasePasswordHashMethod()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.model.jmx.IAuthenticationConfigurator#setDatabasePasswordHashMethod(sk.qbsw.security.model.domain.EHashMethod)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.model.jmx.IAuthenticationConfigurator#getDatabaseAuthSchema()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.model.jmx.IAuthenticationConfigurator#setDatabaseAuthSchema(sk.qbsw.security.model.domain.EAuthSchema)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.model.jmx.IAuthenticationConfigurator#getAdditionalAuthParameters()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.model.jmx.IAuthenticationConfigurator#setAdditionalAuthParameters(java.util.Map)
	 */
	@Override
