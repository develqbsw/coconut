...
public class CRoleJpaDao extends AEntityQDslDao<Long, CRole> implements IRoleDao
{
	...
	/*
	 * (non-Javadoc)
	 * @see sk.qbsw.security.dao.IRoleDao#findByUser(sk.qbsw.security.model.domain.CUser)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see sk.qbsw.security.dao.IRoleDao#findByCode(java.lang.String)
	 */
	@Deprecated
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see sk.qbsw.security.dao.IRoleDao#findOneByCode(java.lang.String)
	 */
	@Override
