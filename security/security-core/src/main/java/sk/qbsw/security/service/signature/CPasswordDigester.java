package sk.qbsw.security.service.signature;
...
public class CPasswordDigester extends AService implements IPasswordDigester
{
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.service.signature.IPasswordDigester#generateDigest(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.security.service.signature.IPasswordDigester#checkPassword(java.lang.String, java.lang.String)
	 */
	@Override
