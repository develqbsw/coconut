...
public class CXUserUnitGroupJpaDao extends AEntityQDslDao<Long, CXUserUnitGroup> implements IXUserUnitGroupDao
{
	...
	/*
	 * (non-Javadoc)
	 * @see sk.qbsw.security.dao.IXUserUnitGroupDao#findByUserAndUnitAndGroup(sk.qbsw.security.model.domain.CUser, sk.qbsw.security.model.domain.CUnit, sk.qbsw.security.model.domain.CGroup)
	 */
	@Override
