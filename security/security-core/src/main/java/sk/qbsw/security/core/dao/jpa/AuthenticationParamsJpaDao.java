...
import sk.qbsw.security.core.model.domain.QCAuthenticationParams;
...
public class AuthenticationParamsJpaDao extends AEntityQDslDao<Long, CAuthenticationParams> implements AuthenticationParamsDao
{
	/**
