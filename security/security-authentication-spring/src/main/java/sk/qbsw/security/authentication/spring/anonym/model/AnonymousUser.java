 ...
 * @since 1.18.4
 */
public class AnonymousUser implements SecurityUserDetails
{
	private static final long serialVersionUID = -7140688514301450963L;
	...
	private static SortedSet<GrantedAuthority> sortAuthorities (Collection<? extends GrantedAuthority> authorities)
	{
		...
		SortedSet<GrantedAuthority> sortedAuthorities = new TreeSet<>(new AnonymousUser.AuthorityComparator());
