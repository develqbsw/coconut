 ...
 */
@Component
public class CheckTokenStrategyImpl implements CheckTokenStrategy
{
	/** The log. */
	private static final Logger LOGGER = LoggerFactory.getLogger(CheckTokenStrategyImpl.class);
	 ...
	 */
	@Override
	public boolean isMasterTokenInactivityReached (MasterToken token)
	{
	 ...
	 */
	@Override
	public boolean isAuthenticationTokenInactivityReached (AuthenticationToken token)
	{
	 ...
	 */
	private boolean isTokenExpired (SecurityToken token, Integer expireLimit)
	{
		if (expireLimit == null)
		{
			return false;
	 ...
	 */
	private boolean isTokenInactivityReached (SecurityToken token, Integer changeLimit)
	{
		if (changeLimit == null)
		{
			return false;
