package sk.qbsw.security.auth.test.util;
...
import sk.qbsw.security.auth.test.util.domain.CLicenseFree;
import sk.qbsw.security.auth.test.util.domain.CLicenseOwner;
