package sk.qbsw.integration.mailchimp.client.validation;
...
import sk.qbsw.integration.mailchimp.client.communication.JacksonFactory;
...
import sk.qbsw.integration.mailchimp.client.model.response.MailchimpErrorResponseBody;
...
public class RequestResponseValidationAspect
{
	 ...
	 */
	@Around ("execution(* sk.qbsw.integration.mailchimp.client.service.MailchimpClientImpl.*(..)) && args(request, ..)")
