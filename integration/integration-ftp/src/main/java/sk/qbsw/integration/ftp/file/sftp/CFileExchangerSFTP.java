package sk.qbsw.integration.ftp.file.sftp;
...
import sk.qbsw.integration.ftp.file.EFileType;
import sk.qbsw.integration.ftp.file.IFileExchanger;
import sk.qbsw.integration.ftp.file.IFileExchangerAuthenticator;
...
public class CFileExchangerSFTP implements IFileExchanger, IFileExchangerAuthenticator
{
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchanger#ls(java.lang.String, sk.qbsw.integration.ftp.file.EFileType)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchanger#get(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchanger#put(java.lang.String, java.io.InputStream)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchanger#connect()
	 */
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchanger#disconnect()
	 */
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchangerAuthenticator#setSimpleAuthentication(java.lang.String, java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchangerAuthenticator#setCertificateAuthentication(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchanger#remove(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see sk.qbsw.integration.ftp.file.IFileExchanger#rename(java.lang.String, java.lang.String)
	 */
	@Override
